...
import ua.company.training.kukuruza.model.dao.mapper.GradeMapper;
...
public class MySqlDaoGrade implements IDaoGrade {
    ...
    private static final String UPDATE_GRADE_SQL = "UPDATE grade SET " +
            "user_id = ?, subject_id = ?, result = ? WHERE id = ?";
    ...
    public Long save(Grade entity) {
        Long autoGeneratedID = helper.save(INSERT_GRADE_SQL, Long.class,
                entity.getUserId(), entity.getSubjectId(), entity.getResult());
    ...
    public void update(Grade entity) {
        helper.update(UPDATE_GRADE_SQL, entity.getUserId(), entity.getSubjectId(), entity.getResult(), entity.getId());
    }
