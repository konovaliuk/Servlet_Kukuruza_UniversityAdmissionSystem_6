...
import ua.company.training.kukuruza.persistence.dao.IDaoEducationOption;
import ua.company.training.kukuruza.persistence.dao.mapper.EducationOptionMapper;
...
public class MySqlDaoEducationOption implements IDaoEducationOption {
    ...
    MySqlDaoEducationOption(IConnectionFactory factory) {
