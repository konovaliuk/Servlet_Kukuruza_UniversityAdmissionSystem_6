...
import ua.company.training.kukuruza.persistence.dao.IDaoSpecialty;
import ua.company.training.kukuruza.persistence.dao.mapper.SpecialtyMapper;
...
public class MySqlDaoSpecialty implements IDaoSpecialty {
    ...
    MySqlDaoSpecialty(IConnectionFactory factory) {
