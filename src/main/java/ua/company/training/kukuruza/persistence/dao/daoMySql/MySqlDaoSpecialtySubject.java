...
import ua.company.training.kukuruza.persistence.dao.IDaoSpecialtySubject;
import ua.company.training.kukuruza.persistence.dao.mapper.SpecialtySubjectMapper;
...
public class MySqlDaoSpecialtySubject implements IDaoSpecialtySubject {
    ...
    MySqlDaoSpecialtySubject(IConnectionFactory factory) {
