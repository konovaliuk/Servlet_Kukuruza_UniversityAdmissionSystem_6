...
import ua.company.training.kukuruza.persistence.dao.IDaoUniversity;
import ua.company.training.kukuruza.persistence.dao.mapper.UniversityMapper;
...
public class MySqlDaoUniversity implements IDaoUniversity {
    ...
    MySqlDaoUniversity(IConnectionFactory factory) {
